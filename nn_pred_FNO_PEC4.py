...
torch.save(mynet.state_dict(),'BNN_FNO_PEC4step_lead'+str(lead)+'.pt') 
...
hdf5storage.write(matfiledata, '.', path_outputs+'predicted_FNO_KS_PEC4step_lead'+str(lead)+'.mat', matlab_compatible=True)
