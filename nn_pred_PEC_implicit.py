...
#      epoch_loss=0
 ...
 #       print('shape of input_batch',input_batch.shape)
        ...
        outputs = implicit_iterations(mynet,input_batch.cuda(),outputs,50)
...
torch.save(mynet.state_dict(),'BNN_Spectral_Loss_'+'lambda_reg'+str(lamda_reg)+'_PEC4step_with_implicit_step_lead'+str(lead)+'.pt') 
