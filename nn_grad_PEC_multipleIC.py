...
f = h5py.File('/media/volume/sdb/RK4_analysis/KS_stuff/new_outputs/predicted_KS_Spectral_Loss_PECstep_lambda_reg_1.0_lead1.mat','r')
...
hdf5storage.write(matfiledata, '.', path_outputs+'Amatrix_KS_one_layer_PECstep_11_ICs_lead'+str(lead)+'.mat', matlab_compatible=True)
