...
f = h5py.File('/home/exouser/RK4_analysis/KS_stuff/new_outputs/predicted_twostep_KS_directstep_lead1.mat','r')
...
mynet = Net()
mynet.load_state_dict(torch.load('BNN_twostep_directstep_lead1.pt'))
mynet.eval()
mynet.cuda()
...
matfiledata = {}
matfiledata[u'A_matrix_direct'] = ygrad
hdf5storage.write(matfiledata, '.', path_outputs+'Amatrix_KS_twostep_directstep_11_ICs_lead'+str(lead)+'.mat', matlab_compatible=True)
