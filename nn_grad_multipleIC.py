...
f = h5py.File('/home/exouser/RK4_analysis/KS_stuff/new_outputs/predicted_KS_Eulerstep_lead1.mat','r')
...
mynet = Net()
mynet.load_state_dict(torch.load('BNN_Eulerstep_lead1.pt'))
mynet.eval()
mynet.cuda()
...
hdf5storage.write(matfiledata, '.', path_outputs+'Amatrix_KS_Eulerstep_11_ICs_lead'+str(lead)+'.mat', matlab_compatible=True)
